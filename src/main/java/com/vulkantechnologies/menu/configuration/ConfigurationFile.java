...
import com.vulkantechnologies.menu.configuration.serializer.vulkan.*;
        ...
        this.loader = YamlConfigurationLoader.builder()
                ...
                .defaultOptions(options -> options.serializers(builder -> {
                    builder
                            ...
                            .register(ItemStackSupplier.class, ItemStackSupplierTypeSerializer.INSTANCE);

                    if (Version.CURRENT.more(Version.V_1_20_5)) {
                        builder.register(Material.class, MaterialTypeSerializer.INSTANCE)
